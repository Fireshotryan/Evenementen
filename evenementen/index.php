            ...
            <div class="bg-gray-800 shadow-xl h-20 fixed bottom-0 mt-12 md:relative md:h-screen z-10 w-full md:w-48 content-center">
                ...
                <div class="md:mt-12 md:w-48 md:fixed md:left-0 md:top-0 content-center md:content-start text-left justify-between">
                    <ul class="list-reset flex flex-row md:flex-col pt-3 md:py-3 px-1 md:px-2 text-center md:text-left">
                        ...
                        <li class="mr-3 flex-1">
                            <a href="Users" class="block py-1 md:py-3 pl-1 align-middle text-white no-underline hover:text-white border-b-2 border-gray-800 hover:border-green-600">
...
<div class="container">
    ...
    <?php if (isset($evenementen) && isset($totalEvenementen)): ?>
        <a class="button" href="add.php">Add new evenement</a>
        <table class="table is-striped mt-4">
            ...
            <tfoot>
            <tr>
                <td colspan="10" class="has-text-centered">&copy; Aantal: <?= $totalEvenementen; ?> evenementen</td>
            </tr>
            </tfoot>
            <tbody>
            <?php foreach ($evenementen as $evenement): ?>
                <tr>
                    <td class="is-vcentered">
                        <img class="image is-64x64" src="images/<?= $evenement->image; ?>" alt="<?= $evenement->name; ?>"/>
                    </td>
                    ...
                    <td class="is-vcentered"><a href="detail.php?id=<?= $evenement->id; ?>">Details</a></td>
                    <td class="is-vcentered"><a href="edit.php?id=<?= $evenement->id; ?>">Edit</a></td>
