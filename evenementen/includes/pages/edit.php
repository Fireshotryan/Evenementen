...
$evenement = $db->getEvenementById($_GET['id']);
...
if (isset($formData) && empty($errors)) {
    ...
    if ($evenement->update($db->getConnection())) {
        $success = 'Your evenement has been updated in the database!';
    } else {
