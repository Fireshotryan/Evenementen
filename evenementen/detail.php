...
<div class="container">
    ...
    <?php if (isset($evenement)): ?>
        <h1 class="title mt-4"><?= $evenement->name . ' - ' . $evenement->description; ?></h1>
        <img class="image is-128x128" src="images/<?= $evenement->image; ?>" alt="<?= $evenement->name; ?>"/>
        <section class="content">
          
                <p>Uitleg: <?= $evenement->description; ?></p>
