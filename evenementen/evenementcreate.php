                ...
                <ul class="list-reset flex justify-between flex-1 md:flex-none items-center">
                    ...
                    <li class="flex-1 md:flex-none md:mr-3">
                        <div class="relative inline-block">
                            <button onclick="toggleDD('myDropdown')" class="drop-button text-white py-2 px-14"> <span class="pr-2"><i class="em em-robot_face"></i></span> Hi, User <svg class="h-3 fill-current inline" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
                            ...
                            <div id="myDropdown" class="dropdownlist absolute bg-gray-800 text-white mt-3 p-3 overflow-auto z-30 invisible">
                                ...
                                <a href="index.php" class="p-2 hover:bg-gray-800 text-white text-sm no-underline hover:no-underline block"><i class="fas fa-sign-out-alt fa-fw"></i> Log Out</a>
                            </div>
                        </div>
                    </li>
                </ul>
                ...
                <div class="md:mt-12 md:w-48 md:fixed md:left-0 md:top-0 content-center md:content-start text-left justify-between">
                    <ul class="list-reset flex flex-row md:flex-col pt-3 md:py-3 px-1 md:px-2 text-center md:text-left">
                        <li class="mr-3 flex-1">
                            <a href="/evenementen/nissewaardevenementen.php" class="block py-1 md:py-3 pl-1 align-middle text-white no-underline hover:text-white border-b-2 border-gray-800 hover:border-pink-500">
                        ...
                        <li class="mr-3 flex-1">
                            <a href="/evenementen/evenementcreate.php" class="block py-1 md:py-3 pl-1 align-middle text-white no-underline hover:text-white border-b-2 border-gray-800 hover:border-pink-500">
                                <i class="fas fa-tasks pr-0 md:pr-3"></i><span class="pb-1 md:pb-0 text-xs md:text-base text-gray-400 md:text-gray-200 block md:inline-block">Create</span>
                            </a>
                        </li>
                        <li class="mr-3 flex-1">
...
include "conn.php";
try {
  $db = new PDO("mysql:localhost=;dbname=evenementsysteem","root","");
}
 ...
 echo $e; 
  ...
  if (isset($_POST['submit'])) {
    ...
    $sql = "INSERT INTO `evenementen`(`naam`, `datum`, `beschrijving`) VALUES ('$Naam','$Datum','$Beschrijving')";
...
<form action="" method="POST">
  ...
  <fieldset>
    ...
    <input type="text" name="naam" require>
    ...
    <input type="text" name="beschrijving" require>
